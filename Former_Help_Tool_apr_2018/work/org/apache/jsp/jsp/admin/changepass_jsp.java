...
String aname=ses.getAttribute("name").toString();

rs=AdminDAO.getProfile(aname);
...
if(no==1)
{
      ...
      out.write("\t<p>Succeefully Changed Password ...!!</p>\r\n");
      out.write("</div>\r\n");
}
if(no==2)
{
...
if(no==3)
{
	...
	while(rs.next())
	{
      ...
      out.print(request.getContextPath() );
      out.write("/ChangePass\" method=\"get\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.print(userid );
      out.write("\"></p>\r\n");
      out.write("\t<p id=\"al\">Your Old Password : <input type=\"text\" name=\"opass\"></input></p>\r\n");
      out.write("\t<p id=\"al\">Your New Password : <input type=\"text\" name=\"npass\"></input></p>\r\n");
      out.write("\t<p id=\"al\">Your Confirm Password : <input type=\"text\" name=\"cpass\"></input></p>\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</div>\r\n");
      out.write("<br>\r\n");
      out.write("<br>\r\n");
      out.write("<center>\r\n");
      out.write("<input type=\"submit\" value=\"Change Password\" class=\"gradientbuttons\" ></input>\r\n");
      out.write("</center>\r\n");
      out.write("</form>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
