...
<body>
 ...
 <form class="login-form" action="<%=request.getContextPath()%>/Vegetable_Yield_Deamand_Calculation"   method="get">
...
<p>
	...
	<table border="1"  id="results"  cellpadding="5px" cellspacing="1px" width="500px;" height="2px">
		...
		<tr>
			...
			<font color="maroon" style="font-style: bold;font-family: monotype corsiva" size="6">suitable vegetable 
			your land specification are select the vegetable..
			</font>
			</td>
				...
				<tr>
			<th><font color="blue" size="" style="font-family: cursive;">Vegetable</font></th>
		...
		%>
						...
						<td><input type="checkbox" name="vegetable" value="<%=rs.getString(1)%>"><%=rs.getString(2)%></td>
